		...
		<div className="block relative">
			<div className="relative">
				<div className="relative flex items-center justify-center w-fit">
					<span className=" z-20 block size-40 uk-border-circle absolute -translate-y-1 translate-x-1 bg-[#3452ff]"></span>
					...
					<span className=" z-20 block size-37 uk-border-circle absolute translate-y-2 -translate-x-2 bg-[#d3a583]"></span>
