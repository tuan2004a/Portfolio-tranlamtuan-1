    ...
    return (
        <div className="uk-width-1-1 grid grid-cols-1 md:grid-cols-2 lg:max-xl:grid-cols-1 gap-3.5 lg:gap-5 ">
            ...
            <div className='border border-[#393939] uk-overflow-hidden rounded-2xl'>
                <div className="uk-width-1-1 py-2.5  lg:py-4 pl-3 lg:pl-4 bg-black uk-flex items-center">
                    <span className="size-9 lg:size-11 uk-border-circle uk-flex uk-flex-center border border-[#3452ff]">
                        {/* <FontAwesomeIcon icon="fa-solid fa-laptop-code" /> */}
                        <FontAwesomeIcon icon={faLaptopCode} className='size-4.5 lg:size-5.5 text-white' />
                    </span>
                    <h5 className='!text-xl lg:!text-[26px] !text-white !font-semibold !m-0 !ml-3'>Lập trình web</h5>
                </div>
                <div className='!m-0 p-3 lg:p-4'>
            ...
            <div className='border border-[#393939] uk-overflow-hidden rounded-2xl'>
                <div className="uk-width-1-1 py-2.5 lg:py-4 pl-3 lg:pl-4 bg-black uk-flex items-center">
                    <span className="size-9 lg:size-11 uk-border-circle uk-flex uk-flex-center border border-[#3452ff]">
                        ...
                        <FontAwesomeIcon icon={faPenRuler} className='size-4 lg:size-5 text-white' />
                    </span>
                    <h5 className='!text-xl lg:!text-[26px] !text-white !font-semibold !m-0 !ml-3'>Thiết kế Web</h5>
                </div>
                <div className='!m-0 p-3 lg:p-4'>
