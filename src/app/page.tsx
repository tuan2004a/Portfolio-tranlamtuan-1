    ...
    return (
        <div className="h-[100vh] w-full p-3.5 md:p-5 lg:p-7 xl:p-10 !gap-7 xl:!gap-10 uk-flex ">
            ...
            <main className="scrollPageHidden lg:w-2/3 h-[calc(100vh-40px)] lg:h-[calc(100vh-80px)] overflow-hidden overflow-y-scroll snap-y snap-mandatory scroll-smooth">
                <div className="bg-[#191919] p-3.5 md:p-5 lg:p-7 xl:p-10 uk-width h-[calc(100vh-40px)] lg:h-[calc(100vh-80px)] snap-start rounded-xl">
                    <Introduce />
                </div>
                <div className="bg-[#191919] p-3.5 md:p-5 lg:p-7 xl:p-10 uk-width h-[calc(100vh-80px)] snap-start mt-3.5 lg:mt-5 rounded-xl">
                    <Experience />
                </div>
                <div className="bg-[#191919] p-3.5 md:p-5 lg:p-7 xl:p-10 uk-width h-[calc(100vh-80px)] snap-start mt-3.5 lg:mt-5 rounded-xl">
                    <ProfessionalSkills />
